...
// Generated by REAPER v5.962+dev1120/x64
...
// last_clicked_cc_lane: returns 0-127=CC, 0x100|(0-31, 99, 101)=14-bit CC, 0x200=velocity, 0x201=pitch, 0x202=program, 0x203=channel pressure, 0x204=bank/program select, 0x205=text, 0x206=sysex, 0x207=off velocity
